 ...
 */
public class ErrorWaveProvider implements WaveProvider {

    @Inject
    public ErrorWaveProvider(Context context, TsunamiApi api) {
    }

    @Override
    public Observable<Wave> getNextWave() {
        Timber.d("getNextWave");
        Observable<Wave> o = Observable.error(new RuntimeException("dicks"));
