...
public class SplashButton extends ImageButton {
    ...
    private void toggle(final boolean visible, final boolean animate, boolean force) {
        if (mVisible != visible || force) {
            ...
            int translationY = visible ? 0 : -1 * (height + getMarginBottom());
            if (animate) {
    ...
    public void attachToListView(@NonNull AbsListView listView) {
        attachToListView(listView, new SplashOnScrollListener());
    }

    public void attachToListView(@NonNull AbsListView listView, @NonNull SplashOnScrollListener onScrollListener) {
        mListView = listView;
        mOnScrollListener = onScrollListener;
        onScrollListener.setSplashButton(this);
